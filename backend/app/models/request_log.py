...
class RequestLog(Base):
    ...
    revisions: Mapped[list] = mapped_column(JSONB, nullable=False, server_default="[]")
    ...
    fact_search_results: Mapped[list] = mapped_column(JSONB, nullable=False, server_default="[]")
